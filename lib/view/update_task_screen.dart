...
import 'package:plan_it/Controllers/task_controller.dart';
...
class _UpdateTaskScreenState extends State<UpdateTaskScreen> {
  ...
  void initState() {
    ...
    titleTextController.text=widget.currentTask.title!;
    _taskController.getCurrentTask(widget.currentTask);
  }
  @override
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: (){
            _taskController.deleteTask(widget.currentTask);
                      ...
                      trailing: IconButton(onPressed: () async {
                        ...
                        if (pickedDate != null) {
                          if(pickedDate.isAfter(DateTime.now())){
                            ...
                            _taskController.selectedDays.clear();
                          }else{
                              ...
                              child: Obx((){
                                return TextButton(
                                    onPressed: (){
                                      ...
                                      if(_taskController.selectedDays.contains(days[index])){
                                        _taskController.selectedDays.remove(days[index]);

                                      }else{
                                        _taskController.selectedDays.add(days[index]);
                                      }
                                      _taskController.dueDate.value='';
                                      _taskController.uiDueDate.value='';
                                    },
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  if(titleTextController.text.isNotEmpty){
                    ...
                    String daysString = _taskController.selectedDays.join(',');
                    String untilTime= '${_taskController.hour.value}:${_taskController.minute.value} ${_taskController.period.value}';
                    final updatedTask = TaskModel(
                        id: widget.currentTask.id,
                        title: titleTextController.text,
                        isCompleted: widget.currentTask.isCompleted,
                        until: '',
                        reminderDays: _taskController.selectedDays.isEmpty?'':daysString,
                        createdDate: DateFormat('E, d MMM yyyy').format(DateTime.now()),
                        dueTime: untilTime,
                        dueDate: _taskController.dueDate.value);
